...
type Args struct {
	Entity string         `json:"entity" jsonschema:"breed | image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.DogSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "dog_list",
		Description: "List records from Dog. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "dog_load",
		Description: "Load a single record from Dog. " +
...
func runOp(client *sdk.DogSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.DogSDK, name string) (sdk.DogEntity, error) {
