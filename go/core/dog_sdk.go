...
import (
	...
	vs "github.com/voxgig-sdk/dog-sdk/go/utility/struct"
)
...
func (sdk *DogSDK) OptionsMap() map[string]any {
...
func (sdk *DogSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *DogSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *DogSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DogSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *DogSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *DogSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("DogSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *DogSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *DogSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("DogSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
