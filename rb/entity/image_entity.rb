...
class ImageEntity
  ...
  # @return [Image, Hash] the loaded Image; raises DogError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Image>, Array] the matching Image items; raises DogError on failure
