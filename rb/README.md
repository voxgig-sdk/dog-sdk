...
The Ruby SDK for the Dog API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `DogError` (a `StandardError` subclass), so wrap
...
The main module (`Dog_sdk`) exports the SDK class
