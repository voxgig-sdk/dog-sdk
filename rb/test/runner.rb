...
module DogTestRunner
  ...
  def self.env_override(m)
    live = getenv("DOG_TEST_LIVE")
    override = getenv("DOG_TEST_OVERRIDE")
    ...
    explain = getenv("DOG_TEST_EXPLAIN")
    m["DOG_TEST_EXPLAIN"] = explain if explain && !explain.empty?
