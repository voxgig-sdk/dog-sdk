...
DogSDK._make_feature = _make_feature


function DogSDK.new(options)
  local self = setmetatable({}, DogSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function DogSDK:get_utility()
  return Utility.copy(self._utility)
end


function DogSDK:get_root_ctx()
  return self._rootctx
end


function DogSDK:prepare(fetchargs)
...
function DogSDK:direct(fetchargs)
...
-- by passing it.
function DogSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function DogSDK:graphql(query, variables, ctrl)
...
function DogSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
