...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dog` | `npm install @voxgig-sdk/dog` |
| Python | `voxgig-sdk-dog` | `pip install voxgig-sdk-dog` |
| PHP | `voxgig-sdk/dog` | `composer require voxgig-sdk/dog` |
| Golang | `github.com/voxgig-sdk/dog-sdk/go` | `go get github.com/voxgig-sdk/dog-sdk/go` |
| Ruby | `voxgig-sdk-dog` | `gem install voxgig-sdk-dog` |
| Lua | `voxgig-sdk-dog` | `luarocks install voxgig-sdk-dog` |
