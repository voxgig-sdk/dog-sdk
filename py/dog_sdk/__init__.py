...
from dog_sdk.utility import register

# Load features
from dog_sdk.feature.base_feature import DogBaseFeature
from dog_sdk.features import _has_feature, _make_feature
...
class DogSDK:
    ...
    def get_utility(self):
        return DogUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DogSDK: graphql: " + str(msg))
            res["graphql"] = errors
