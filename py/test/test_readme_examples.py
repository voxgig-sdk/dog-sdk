# Dog SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DogSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DogSDK(...) and DogSDK.test(...) become
#      DogSDK.test({"entity": {...}}) seeding one mock record (id "test01")
