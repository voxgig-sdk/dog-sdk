...
from dog_sdk.utility.voxgig_struct import voxgig_struct as vs
from dog_sdk import DogSDK
from dog_sdk.core.spec import DogSpec
from dog_sdk.core.result import DogResult
from dog_sdk.core.response import DogResponse
from dog_sdk.core.operation import DogOperation
from dog_sdk.core.error import DogError
from dog_sdk.core import helpers
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = DogSDK.test(None, None)
        ...
        class TestInitFeature(DogBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(DogBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DogSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DogSDK.test(None, setup_opts)
