# Dog Python SDK Reference

Complete API reference for the Dog Python SDK.
...
#### `DogSDK.test(testopts=None, sdkopts=None)`
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `message` | `list` | No | Array of random image URLs for the breed |
| `status` | `str` | No |  |
