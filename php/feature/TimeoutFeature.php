...
class DogTimeoutFeature extends DogBaseFeature
{
    ...
    private function _with_timeout(DogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DogContext $_ctx, float $ms): void
    {
        $client = $this->client;
