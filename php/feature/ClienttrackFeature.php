...
class DogClienttrackFeature extends DogBaseFeature
{
    ...
    public function PostConstruct(DogContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Dog-SDK';
