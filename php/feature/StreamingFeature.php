...
class DogStreamingFeature extends DogBaseFeature
{
    ...
    private function _iterate(DogResult $result): \Generator
    {
    ...
    private function _streamable(DogContext $ctx): bool
    {
