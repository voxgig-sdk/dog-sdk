...
// Dog SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DogSDK::test)
...
{
    private const SDK_CLASS = 'DogSDK';
    ...
    private const SDK_BASE = 'dog_sdk';
