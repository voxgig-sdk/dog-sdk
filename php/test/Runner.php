...
class DogTestRunner
{
    ...
    {
        $live = self::getenv('DOG_TEST_LIVE');
        $override = self::getenv('DOG_TEST_OVERRIDE');
        ...
        $explain = self::getenv('DOG_TEST_EXPLAIN');
...
class_alias('DogTestRunner', 'Runner');
class_alias('DogHelpers', 'Helpers');
