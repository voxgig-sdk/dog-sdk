...
The TypeScript SDK for the Dog API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Breed()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `DogSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `DogSDK.test(testopts?, sdkopts?)` | `DogSDK` | Create a test-mode client. |
...
| `client` | `client(): DogSDK` | Return the parent SDK client. |
