...
class DogTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DogTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = DogTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = DogTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
