...
class DogTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = DogTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = DogTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = DogTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
