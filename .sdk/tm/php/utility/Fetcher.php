...
class DogFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DogSDK/1.0)';
    ...
    public static function call(DogContext $ctx, string $fullurl, array $fetchdef): array
    {
