...
// Dog SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class DogMakeRequest
{
    public static function call(DogContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new DogResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new DogResponse($fetched);
        } else {
