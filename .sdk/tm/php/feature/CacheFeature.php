...
class DogCacheFeature extends DogBaseFeature
{
    ...
    private function _through(DogContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
