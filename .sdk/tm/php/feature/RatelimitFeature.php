...
class DogRatelimitFeature extends DogBaseFeature
{
    ...
    private function _acquire(DogContext $ctx): void
    {
    ...
    private function _track(DogContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
