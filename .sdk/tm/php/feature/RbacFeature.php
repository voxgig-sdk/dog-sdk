...
class DogRbacFeature extends DogBaseFeature
{
    ...
    private function _required(DogContext $ctx): ?string
    {
    ...
    private function _reject(DogContext $ctx, string $required): void
    {
    ...
    private function _track(DogContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
