...
|---|---|---|
| `ts/` | @voxgig-sdk/dog-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dog-sdk \
      --repository voxgig-sdk/dog-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dog-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dog-sdk --id=<id>` removes it.
